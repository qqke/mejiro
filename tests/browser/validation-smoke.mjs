...
await withPreviewPage(async ({ page, baseUrl }) => {
  ...
  await page.locator("#start-at").fill("2026-05-20T18:30");
  await page.locator("#end-at").fill("2026-05-20T18:45");
  ...
  await page.locator("#start-at").fill("2026-05-20T10:30");
  await page.locator("#end-at").fill("2026-05-20T11:30");
